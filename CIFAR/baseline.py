...
if args.dataset == 'cifar10':
    train_data = dset.CIFAR10('/iris/u/cchoi1/exploring_ood/data/CIFAR10', train=True, transform=train_transform)
    test_data = dset.CIFAR10('/iris/u/cchoi1/exploring_ood/data/CIFAR10', train=False, transform=test_transform)
    num_classes = 10
else:
    train_data = dset.CIFAR100('/iris/u/cchoi1/exploring_ood/data/CIFAR10', train=True, transform=train_transform)
    test_data = dset.CIFAR100('/iris/u/cchoi1/exploring_ood/data/CIFAR10', train=False, transform=test_transform)
    num_classes = 100
