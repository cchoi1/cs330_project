...
test_data = svhn.SVHN('/iris/u/cchoi1/exploring_ood/data/SVHN', split='test',
...
ood_data = dset.CIFAR10('/iris/u/cchoi1/exploring_ood/data/CIFAR10', train=False, transform=trn.ToTensor(), download=False)
ood_loader = torch.utils.data.DataLoader(ood_data, batch_size=args.test_bs, shuffle=True,
                                         num_workers=args.prefetch, pin_memory=True)
...
ood_data = dset.CIFAR100('/iris/u/cchoi1/exploring_ood/data/CIFAR100', train=False, transform=trn.ToTensor(), download=False)
ood_loader = torch.utils.data.DataLoader(ood_data, batch_size=args.test_bs, shuffle=True,
                                         num_workers=args.prefetch, pin_memory=True)
